    ...
    "paths": {
        ...
        "/messages": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Maximum messages to return (max 100)",
                        "name": "limit",
                        "in": "query"
                    },
                    {
                        "type": "integer",
                        "description": "Epoch seconds cursor for pagination",
                        "name": "before",
                        "in": "query"
                    }
                ],
        ...
        "/startups": {
            ...
            "delete": {
                ...
                "responses": {
                    "200": {
                        "description": "All startups deleted successfully",
                        "schema": {
                            "$ref": "#/definitions/response.APIResponse"
                        }
                    },
